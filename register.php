        ...
        <div class="row justify-center">
            <div class="col-xl-6 col-lg-7 col-md-9">
                <div class="px-50 py-50 sm:px-20 sm:py-20 bg-white shadow-4 rounded-4">
                    <form method='post' action='index.php?controller=register' onsubmit="return checkPassword()">
                    <div class="row y-gap-20">
                        <div class="col-12">
                            <h1 class="text-22 fw-500">Đăng kí tài khoản mới</h1>
                            <p class="mt-10">Bạn đã có tài khoản?<a href="/admin.php?controller=home&action=login" class="text-blue-1">Đăng Nhập</a></p>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-input ">
                                ...
                                <label class="lh-1 text-14 text-light-1">User Name</label>
                            </div>
...
<p class="mt-10"> <a href="index.php"
        ...
        function checkPassword() {
            ...
            if (password !== confirmPassword) {
                ...
                // Các xử lý khác hoặc gửi form đi nếu mật khẩu khớp
                return true;
            }
        }
    </script>
