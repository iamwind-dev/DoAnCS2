<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from creativelayers.net/themes/gotrip-html/db-vendor-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Nov 2023 12:13:26 GMT -->
        ...
        <div class="row justify-between items-center pl-60 lg:pl-20">
          <div class="col-auto">
            <div class="d-flex items-center">
              ...
              <div
                class="single-field relative d-flex items-center md:d-none ml-30"
              >
                <input
          ...
          <div class="col-auto">
            <div class="d-flex items-center">
                            ...
                            <div class="tabs__content js-tabs-content">
                              ...
                              <div class="tabs__pane -tab-item-2">
                                <div class="mega__content">
                                  ...
                                  <div class="mega__image d-flex relative">
                                    <img
                                      src="/public/img/backgrounds/7.png"
                                      alt="image"
                                      class="rounded-4"
                                    />
              ...
              <div class="row items-center x-gap-5 y-gap-20 pl-20 lg:d-none">
                <div class="col-auto">
                  <button
                    class="button -blue-1-05 size-50 rounded-22 flex-center"
                  >
              ...
              <div
                class="d-none xl:d-flex x-gap-20 items-center pl-20"
      ...
      <div class="dashboard__sidebar bg-white scroll-bar-1">
        <div class="sidebar -dashboard">
          <div class="sidebar__item">
            ...
            >
              <img
                src="/public/img/dashboard/sidebar/compass.svg"
                alt="image"
                class="mr-15"
              />
              Dashboard
          ...
          <div class="sidebar__item">
            ...
            >
              <img
                src="/public/img/dashboard/sidebar/booking.svg"
                alt="image"
                class="mr-15"
              />
              Booking Manager
            ...
            <div class="accordion -db-sidebar js-accordion">
              <div class="accordion__item">
                <div class="accordion__button">
                  <div
                    class="sidebar__button col-12 d-flex items-center justify-between"
                  >
                    <div class="d-flex items-center text-15 lh-1 fw-500">
                      <img
                        src="/public/img/dashboard/sidebar/hotel.svg"
                        alt="image"
                        class="mr-10"
                      />
                      Manage Hotel
              ...
              <div class="accordion__item">
                <div class="accordion__button">
                  ...
                  >
                    <div class="d-flex items-center text-15 lh-1 fw-500">
                      <img
                        src="/public/img/dashboard/sidebar/map.svg"
                        alt="image"
                        class="mr-10"
                      />
                      Manage Tour
              ...
              <div class="accordion__item">
                <div class="accordion__button">
                  ...
                  >
                    <div class="d-flex items-center text-15 lh-1 fw-500">
                      <img
                        src="/public/img/dashboard/sidebar/sneakers.svg"
                        alt="image"
                        class="mr-10"
                      />
                      Manage Activity
              ...
              <div class="accordion__item">
                <div class="accordion__button">
                  ...
                  >
                    <div class="d-flex items-center text-15 lh-1 fw-500">
                      <img
                        src="/public/img/dashboard/sidebar/house.svg"
                        alt="image"
                        class="mr-10"
                      />
              ...
              <div class="accordion__item">
                <div class="accordion__button">
                  ...
                  >
                    <div class="d-flex items-center text-15 lh-1 fw-500">
                      <img
                        src="/public/img/dashboard/sidebar/taxi.svg"
                        alt="image"
                        class="mr-10"
                      />
                      Manage Car
              ...
              <div class="accordion__item">
                <div class="accordion__button">
                  ...
                  >
                    <div class="d-flex items-center text-15 lh-1 fw-500">
                      <img
                        src="/public/img/dashboard/sidebar/canoe.svg"
                        alt="image"
                        class="mr-10"
                      />
                      Manage Cruise
              ...
              <div class="accordion__item">
                <div class="accordion__button">
                  ...
                  >
                    <div class="d-flex items-center text-15 lh-1 fw-500">
                      <img
                        src="/public/img/dashboard/sidebar/airplane.svg"
                        alt="image"
                        class="mr-10"
                      />
                      Manage Flights
          ...
          <div class="sidebar__item">
            ...
            >
              <img
                src="/public/img/dashboard/sidebar/log-out.svg"
                alt="image"
                class="mr-15"
              />
              Logout
            ...
            <div class="col-xl-7 col-md-6">
              <div class="py-30 px-30 rounded-4 bg-white shadow-3">
                <div class="d-flex justify-between items-center">
                  <h2 class="text-18 lh-1 fw-500">Earning Statistics</h2>

                  <div class="dropdown js-dropdown js-category-active">
                    <div
                      class="dropdown__button d-flex items-center bg-white border-light rounded-100 px-15 py-10 text-14 lh-12"
                    ...
                    <div
                      class="toggle-element -dropdown js-click-dropdown js-category-toggle"
                    >
            ...
            <div class="col-xl-5 col-md-6">
              <div class="py-30 px-30 rounded-4 bg-white shadow-3">
                <div class="d-flex justify-between items-center">
                  ...
                  <div class="">
                    <a href="#" class="text-14 text-blue-1 fw-500 underline"
                      >View All</a
                    >
                  </div>
                </div>
  ...
  <!-- Mirrored from creativelayers.net/themes/gotrip-html/db-vendor-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Nov 2023 12:13:28 GMT -->
</html>
