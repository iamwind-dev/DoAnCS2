            ...
            <div class="dashboard__content bg-light-2">
                <div class="row y-gap-20 justify-between items-end pb-60 lg:pb-40 md:pb-32">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="../../../admin.php?controller=tour&amp;action=add" class="button h-50 px-24 -dark-1 bg-blue-1 text-white">
                            ...
                            <div class="tabs__pane -tab-item-1 is-tab-el-active">
                                <div class="overflow-scroll scroll-bar-1">
                                    <table class="table-4 -border-bottom col-12">
                                        ...
                                        <tbody>
                                    <?php while ($tour=mysqli_fetch_array($query)) {
                                        ?>
                                            <tr>
                                                
                                                <td>1</td>
                                                <td class="text-blue-1 fw-500"><?php echo $tour['tour_name'];
                                        ?></td>
                                                <td style="width: 400px; "><img style="max-width: 200px; height: 150px;"src="/public/img/tours/<?php echo $tour['tour_image_url']?>"></td>
                                                <td style="width: 400px; height: 150px;"><b>Lịch Trình:</b><?php echo $tour['tour_schedule']; ?><br><b>Giá:</b><?php echo $tour['tour_price']; ?></td>
                                                    <td><b>Địa điểm:</b><?php echo $tour['location_name']; ?><br><b>Di Chuyển:</b><?php echo $tour['tour_vehicle']; ?><br><b>Điểm Xuất Phát:</b><?php echo $tour['tour_starting_point']; ?><br><b>Ngày đi: </b><?php echo $tour['tour_start_date']; ?><br><b>Ngày về: </b><?php echo $tour['tour_end_date']; ?></td>
                                                    <td><span
                                                            class="rounded-100 py-4 px-10 text-center text-14 fw-500 bg-success-4 text-success-4">Pending</span>
                                                    </td>
                                                    <td>
                                                        <div
                                                            class="rounded-4 size-35 bg-blue-1 text-white flex-center text-12 fw-600">
                                                            4.8</div>
                                                    </td>
                                                    <td>
                                                        <div class="row x-gap-10 y-gap-10 items-center">
                                                            ...
                                                            <div class="col-auto">
                                                                <a href="../../../admin.php?controller=tour&amp;action=edit"><button class="flex-center bg-light-2 rounded-4 size-35">
                                                            ...
                                                            <div class="col-auto">
                                                                <a href="../../../admin.php?controller=tour&amp;action=edit&amp;id=<?php echo $tour['tour_id']; ?>"><button class="flex-center bg-light-2 rounded-4 size-35">
                                                            ...
                                                            <div class="col-auto">
                                                                <a href="../../../admin.php?controller=tour&amp;action=delete"><button class="flex-center bg-light-2 rounded-4 size-35">
