                            ...
                            <label class="lh-1 text-16 text-light-1">Tên Tour</label>
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div class="form-input ">
                                                <select name="diadiem" id="select1">
                                                    <option id="op1"
                                                        value="<?php echo $element['tour_location_id']; ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            ...
                                            <div class="form-input ">
                                                <input name="sltg" type="text" required value="<?php echo $element['tour_max_capacity'];?>">
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div class="form-input ">
                                                <input name="gia" type="text" required value="<?php echo $element['tour_price'];  ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            ...
                                            <div class="form-input ">
                                                <input name="phuongtien" type="text" required value="<?php echo $element['tour_vehicle'];?>">
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div class="form-input ">
                                                <input name="diemxp" type="text" required value="<?php echo $element['tour_starting_point'];?>">
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            ...
                                            <div class="form-input ">
                                                <input name="hanhtrinh" type="text" required value="<?php echo $element['tour_journey'];?>">
                                        ...
                                        <div class="col-5">
                                            ...
                                            <div class="form-input ">
                                                <input name="lichtrinh" type="text" value="<?php echo $element['tour_schedule']; ?>">
                                                <label class="lh-1 text-16 text-light-1">Địa Điểm xuất
                                                    phát</label>
                                            </div>
                                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-input ">
                                        <textarea name="gioithieu" id="editor1" value=""> <?php echo $element['tour_introduction'];?>       </textarea>
                                    </div>
                                </div>
                                <div class="mt-30">
