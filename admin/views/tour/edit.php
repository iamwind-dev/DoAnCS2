...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/db-vendor-add-hotel.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Nov 2023 12:13:28 GMT -->
                        ...
                        <div class="tabs__content pt-30 js-tabs-content">
                            <div class="tabs__pane -tab-item-1 is-tab-el-active">
                                ...
                                foreach ($data as $element) { ?>
                                    <form id="myform" action="../../../admin.php?controller=tour&amp;action=edit"
                                        method="post" enctype="multipart/form-data">
                                        <input type="text" name="id" value="<?php echo $element['tour_id'] ?>"hidden>
                                        <div class="text-18 fw-500 mb-10">Tên Tour</div>
                                        <div class="row x-gap-20 y-gap-20">
                                            <div class="col-12">
                                                <div class="form-input ">
                                                    <input name="tentour" type="text" required value="<?php echo $element['tour_name']; ?>">
                                ...
                                <option id="op1" value="<?php echo $element['tour_location_id']; ?>"><?php echo $element['location_name']; ?></option>
                                <?php foreach ($data1 as $element1) {  ?>
                                <option id="op1" value="<?php echo $element1['location_id']; ?>">
                                    ...
                                    <?php } ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-5">
                                                        ...
                                                        <div class="form-input ">
                                                            <input name="sltg" type="text" required value="<?php
                                                            
                                                                echo $element['tour_max_capacity'];
                                                            ?>">
                                                    ...
                                                    <div class="col-5">
                                                        ...
                                                        <div class="form-input ">
                                                            <input name="gia" type="text" required value="<?php

                                                                echo $element['tour_price'];
                                                                ?>">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-5">
                                                        ...
                                                        <div class="form-input ">
                                                            <input name="phuongtien" type="text" required value="<?php

                                                                echo $element['tour_vehicle'];
                                                                ?>">
                                                        ...
                                                        <div class="col-5">
                                                            ...
                                                            <div class="form-input ">
                                                                <input name="diemxp" type="text" required value="<?php

                                                                    echo $element['tour_starting_point'];
                                                                    ?>">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-5">
                                                                ...
                                                                <div class="form-input ">
                                                                    <input name="hanhtrinh" type="text" required value="<?php

                                                                        echo $element['tour_journey'];
                                                                        ?>">
                                                                ...
                                                                <div class="col-5">
                                                                    ...
                                                                    <div class="form-input ">
                                                                        <input name="lichtrinh" type="text"  value="<?php

                                                                            echo $element['tour_schedule'];
                                                                            ?>">
                                                                            <label class="lh-1 text-16 text-light-1">Địa Điểm xuất
                                                                                phát</label>
                                                                        </div>
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <div class="form-input ">
                                                                    <textarea name="mota" id="editor" value=""><?php

                                                                        echo $element['tour_description'];
                                                                        ?></textarea>
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="form-input ">
                                                                        <textarea name="gioithieu" id="editor1" value=""><?php

                                                                            echo $element['tour_introduction'];
                                                                            ?></textarea>
                                                ...
                                                <div class="mt-30">
                                                    ...
                                                    <div class="containerr">
                                                        ...
                                                        <div class="img-area" data-img="">
                                                            ...
                                                            <img src="../../../public/img/tours/<?php echo $element['tour_image_url'];  ?>" alt="">
                                                        </div>
                                                        <button type="button" class="select-image">Select Image</button>
                                                    </div>
                                                </div>
                                                <input type="text" name="image" id="" value="<?php echo $element['tour_image_url']; ?>" hidden>
