...
<head>
  ...
  <!-- favicon -->
  <link rel="shortcut icon" type="png" href="img/general/favicon.png">
</head>
...
<body>
  <div class="preloader js-preloader">
    ...
    <div class="preloader__title">WinK</div>
  </div>
      ...
      <div class="row justify-between items-center">
        ...
        <div class="col-auto">
          <div class="d-flex items-center">
            <a href="home.php" class="header-logo mr-20" data-x="header-logo" data-x-toggle="is-logo-dark">
              <img src="img/general/logo-dark (1).svg" alt="logo icon">
        ...
        <div class="col-auto">
          <div class="d-flex items-center">
            ...
            <div class="d-flex items-center ml-20 is-menu-opened-hide md:d-none">
              ...
              $sql = "SELECT * FROM taikhoan where idkh = $idkh";
              $result = mysqli_query($conn, $sql);
              $row = $result->fetch_assoc();
              ?>
              <a href="yeuthich.php" class="button px-30 fw-400 text-14 border-white -blue-1 h-50 text-white ml-20">Yêu Thích</a>
              <a href="thongtinkhachhang.php?idkh=<?php echo $_SESSION["idkh"] ?>" class="button px-30 fw-400 text-14 -blue-1 bg-white h-50 text-dark-1 ml-20"><?php echo $_SESSION['tenkh'] . ' ' . $_SESSION['hokh']  ?></a>
              <div class="pl-15">
                <img src="img/user/<?php echo $row['anh'] ?>" alt="image" class="size-50 rounded-22 object-cover">
              </div>
            </div>
