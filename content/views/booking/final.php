                    ...
                    <div class="col-xl-7 col-lg-8">
                        ...
                        <?php foreach ($data2 as $a) { ?>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        ...
                                        <div class="text-15 lh-12 fw-500 text-blue-1 mt-10"><?php foreach ($data as $b) {
                                            echo $b['tour_price'];} ?></div>
                                    </div>
                            ...
                            <div class="border-light rounded-8 px-50 py-40 mt-40">
                                ...
                                <div class="row y-gap-10">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-between border-top-light pt-10">
                                            <div class="text-15 lh-16">Thành Phố</div>
                                            <div class="text-15 lh-16 fw-500 text-blue-1">Huế</div>
                                        </div>
                                    </div>
                            ...
                            <div class="px-30 py-30 border-light rounded-4">
                                ...
                                <?php foreach ($data as $e) { ?>
                                    <div class="row x-gap-15 y-gap-20">
                                        <div class="col-auto">
                                            <img src="../../../public/img/tours/<?php echo $e['tour_image_url'] ?>"
                                                alt="image" class="size-140 rounded-4 object-cover">
                                        </div>
