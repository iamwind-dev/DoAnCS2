                ...
                <div class="sidebar__item">
                    <div class="sidebar__button ">
                        <a href="db-wishlist.html" class="d-flex items-center text-15 lh-1 fw-500">
                            <img src="/public/img/dashboard/sidebar/bookmark.svg" alt="image" class="mr-15">
                            Wishlist
                        </a>
                    </div>
                </div>
                ...
                <div class="sidebar__item">
                    <div class="sidebar__button ">
                        <a href="db-settings.html" class="d-flex items-center text-15 lh-1 fw-500">
                            <img src="/public/img/dashboard/sidebar/gear.svg" alt="image" class="mr-15">
                            Settings
                        </a>
                    </div>
                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="col-2">
                                                            ...
                                                            <div class="form-input ">
                                                                <input type="text" required>
                                                                <label class="lh-1 text-16 text-light-1">Sunny
                                                                    beach</label>
                                                            </div>
                                                        ...
                                                        <td class="col-2">
                                                            ...
                                                            <div class="form-input ">
                                                                <input type="text" required>
                                                                <label class="lh-1 text-16 text-light-1">Select
                                                                    Country</label>
                                                            </div>
                                ...
                                <div class="col-xl-9 col-lg-11">
                                    ...
                                    <div class="row x-gap-20 y-gap-20">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-input ">
                                                <input type="text" required>
                                                <label class="lh-1 text-16 text-light-1">Minimum advance
                                                    reservations</label>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-input ">
                                                <input type="text" required>
                                                <label class="lh-1 text-16 text-light-1">Minimum day stay
                                                    requirements</label>
                                            </div>
