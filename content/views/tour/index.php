                ...
                <div class="row y-gap-10 items-center justify-between">
                    <div class="col-auto">
                        <div class="row x-gap-10 y-gap-5 items-center text-14 text-light-1">
                            ...
                            <div class="col-auto"><a href="index.php">
                                <div class="">Trang chủ</div></a>
                            </div>
                            <div class="col-auto">
                                <div class=""></div>
                            </div>
                            <div class="col-auto"><a href="index.php">
                                <div class=""><?php echo $e['tour_location_name'] ?></div></a>
                            </div>
                            <div class="col-auto">
                                <div class="">> <?php echo $e['tour_name'] ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <a href="#" class="text-14 text-blue-1 underline">Tất cả Tour <?php echo $e['tour_location_name'] ?></a>
                    </div>
                    <?php } ?>
                </div>
            </div>
        ...
        <section class="pt-40">
            ...
            <div class="container">
                <div class="row y-gap-15 justify-between items-end">
                    <div class="col-auto">
                        <h1 class="text-30 fw-600"><?php echo $e['tour_name'] ?></h1>
                                ...
                                <div class="row x-gap-10 items-center">
                                    <div class="col-auto">
                                        <div class="d-flex x-gap-5 items-center">
                                            ...
                                            <div class="text-15 text-light-1"><?php echo $e['tour_location_name'] ?></div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-8">
                        <div class="relative d-flex justify-center overflow-hidden js-section-slider"
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="../../../public/img/gallery/1/4.png" alt="image"
                                        class="rounded-4 col-12 h-full object-cover">
                                </div>
                            ...
                            <div class="absolute h-full col-12 z-2 px-20 py-20 d-flex justify-end items-end">
                                <a href="../../../public/img/tours/<?php echo $e['tour_image_url'] ?>"
                        ...
                        <div class="row y-gap-30 justify-between pt-20">
                            ...
                            <div class="col-md-auto col-6">
                                <div class="d-flex">
                                    ...
                                    <div class="text-15 lh-15">
                                        Lịch Trình:<br><?php echo $e['tour_schedule'] ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-auto col-6">
                                <div class="d-flex">
                                    ...
                                    <div class="text-15 lh-15">
                                        Số lượng:<br><?php echo $e['tour_max_capacity'] ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-auto col-6">
                                <div class="d-flex">
                                    ...
                                    <div class="text-15 lh-15">
                                        Phương tiện:<br><?php echo $e['tour_vehicle'] ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row x-gap-40 y-gap-40">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="text-15 mt-10">Được hoàn đủ tiền,hãy huỷ ít nhất trước 24h.</div>
                            </div>
                            ...
                            <div class="w-360 lg:w-full d-flex flex-column items-center">
                                <div class="px-30 py-30 rounded-4 border-light bg-white shadow-4">
                                    <div class="text-14 text-light-1">
                                        <span class="text-20 fw-500 text-dark-1 ml-5">Giá: <br>
                                                                             <?php echo number_format($e['tour_price'], 0, ',', '.').'VND'; ?></span>
                                    </div>
                                ...
                                <div class="px-30">
                                    <div class="text-14 text-light-1 mt-30">Not sure? You can cancel this reservation up
                                        to 24 hours in advance for a full refund.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="accordion__item ">
                                        <div class="d-flex">
                                            <div
                                                ...
                                                <div class="text-14 fw-500"><?php echo $a; $a++; ?></div>
                                            </div>

                                            <div class="ml-20">
                                                <div class="text-16 lh-15 fw-500"><?php echo $mang[$i]; $i++; ?></div>
                                                <div class="text-14 lh-15 text-light-1 mt-5"><?php echo $mang[$i];
                                                    $i++; ?></div>
                        ...
                        <div class="row y-gap-40">
                            ...
                            <div class="col-12">
                                ...
                                <p class="text-15 text-dark-1 mt-10">Nice two level apartment in great London location.
                                    Located in quiet small street, but just 50 meters from main street and bus stop.
                                    Tube station is short walk, just like two grocery stores. </p>
