...
<section class="pt-40">
    <div class="container">
        <div class="row x-gap-40 y-gap-30 items-center">
            ...
            <div class="col-auto">
                <div class="d-flex items-center">
                    <div id="step2" class="size-40 rounded-full flex-center bg-blue-1"><i
                            class="icon-check text-16 text-white"></i>
                    </div>
                            ...
                            <div class="row y-gap-10">
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-between ">
                                        ...
                                        <div id="hotenn" class="text-15 lh-16 fw-500 text-blue-1">
